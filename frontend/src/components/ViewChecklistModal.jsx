...
function ViewChecklistModal({ onClose }) {
  ...
  return (
    <div className="bg-white rounded-3xl border-2 border-gray-400 p-6 shadow-lg w-full max-w-md mx-4 sm:mx-auto" style={{ fontFamily: 'K2D, sans-serif' }}>
        ...
        <ul className="space-y-3">
            ...
            <li className="flex justify-between items-center bg-gray-100 p-2 rounded-lg">
                ...
                <div className="flex gap-3">
                    ...
                    <img src="/trash.png" className="w-5 h-5 cursor-pointer" alt="Delete" />
                    </button>
                </div>
            </li>
